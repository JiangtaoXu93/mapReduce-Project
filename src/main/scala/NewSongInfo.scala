...
//author: Jiangtao
class NewSongInfo(track : String, ai : String, si : String, du : String, ld : String, sh : String, ah : String, tp: String, af: String, an: String, st: String) extends Serializable{
